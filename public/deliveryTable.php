...
<h1 class="tab-head">Deliveries</h1>
  <div style = "padding-bottom:5px;">
    <button class="btn w3-green"><a href="../Delivery.html"><i class="fa fa-plus"></i> Add Order</a></button>
  </div>
<table>
    <tr>
    <th>Delivery ID</th>
    ...
    $sql = "SELECT del_id, cust_id, cont_id, prod_id, unit_price FROM delivery";
    ...
    while($row = $result->fetch_assoc()) {
      ...
      <a href = "deliveryTable.php?delete=<?php echo $row["del_id"]; ?>" onclick = "return confirm('Are you sure ?');">Delete</a>
      </span>
      </td>
    </tr>
    <?php
    ...
    if(isset ($_GET['delete']) ){
      ...
      mysqli_query($conn,"DELETE FROM delivery WHERE del_id = '". $delete_id ."'");
      ?>
      <META HTTP-EQUIV="Refresh" CONTENT = "0; URL = http://localhost/water_db/public/deliveryTable.php">
      <?php
    }
    echo "</table>";
    } else { echo "0 results"; }
