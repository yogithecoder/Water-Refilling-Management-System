...
<div class="w3-sidebar w3-light-grey w3-card-4 w3-animate-left" style="width: 180px; display: none;" id="mySidebar">
    ...
    <h1 class="tab-head">Products</h1>
    <div style = "padding-bottom:5px;">
      <button class="btn w3-green"><a href="../Product.html"><i class="fa fa-plus"></i> Add Product</a></button>
    </div>
    <table>
        <tr>
            <th>Product ID</th>
...
$sql = "SELECT prod_id,name, des, quantity, on_hand, unit_price FROM product";
...
while($row = $result->fetch_assoc()) {
  ...
  <a href = "productTable.php?delete=<?php echo $row["prod_id"]; ?>" onclick = "return confirm('Are you sure ?');">Delete</a>
  </span>
  </td>
</tr>
<?php
...
if(isset ($_GET['delete']) ){
  ...
  mysqli_query($conn,"DELETE FROM product WHERE prod_id = '". $delete_id ."'");
  ?>
  <META HTTP-EQUIV="Refresh" CONTENT = "0; URL = http://localhost/water_db/public/productTable.php">
  <?php
}
echo "</table>";
} else { echo "0 results"; }
